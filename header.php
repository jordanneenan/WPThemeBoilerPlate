...
<html>
    ...
    <body>
        ...
        <?php
            ...
            $isHome = 'not-home';
            $absPos = '';
            $logo = 'driven-mark-dark';
            if(is_front_page() || $post_slug == 'style-guide'){
                $isHome = 'is-home';
                $absPos = 'absolute_pos';

                $logo = 'driven-mark-light';
            } 
        ?>

            <header class="underline slide_down cfx <?php echo $isHome; ?> <?php echo $absPos; ?> fade-header">
                <div class="logo">
                    <a href="/">
                        <img src="<?php echo $GLOBALS['pathImg']; ?><?php echo $logo; ?>.svg" alt="Driven">
                    </a>
                </div>
